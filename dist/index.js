...
const file_command_1 = __nccwpck_require__(785);
const utils_1 = __nccwpck_require__(814);
const os = __importStar(__nccwpck_require__(37));
const path = __importStar(__nccwpck_require__(17));
const oidc_utils_1 = __nccwpck_require__(318);
/**
...
const pm = __nccwpck_require__(900);
let tunnel;
var HttpCodes;
(function (HttpCodes) {
...
class HttpClient {
    ...
    _getAgent(parsedUrl) {
        ...
        if (useProxy) {
            ...
            if (!tunnel) {
                tunnel = __nccwpck_require__(614);
            }
            const agentOptions = {
...
module.exports = __nccwpck_require__(343);
...
(() => {
const core = __nccwpck_require__(536);
